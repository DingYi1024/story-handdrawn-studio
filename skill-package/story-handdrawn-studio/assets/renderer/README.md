...
- 首帧直接显示黑白画稿，再叠加文字；最后一个字完成后下一帧立即开始整幅彩色显影，没有停顿或纯白过渡
- `revise` 指定镜头局部重做，旧版本归档，新素材不覆盖已验收母图
- 角色、服装、道具、场景、时间、配色连续性账本；当前镜头人物必须显式声明，不会串场
- 自动视频 QA：首帧、逐幕文字/彩色无停顿交接、尺寸、帧率、时长、音频流、黑白空帧和疑似重复帧
...
上方 GIF 只展示画面；点击它即可打开带声音的正式 MP4。案例为 9:16、4 幕、8 镜头、27.5 秒，同一角色贯穿，完整展示 `黑白画稿 → 文字写完即彩色显影`、推拉/平移/视差与局部手绘微动画、三次卷页转场，以及原创背景音乐、雨声、浇水声、鸟鸣和同步翻页声。
